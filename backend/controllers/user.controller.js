...
module.exports.signup = async (req, res, next) => {
    try {
        const { email, password, username, role, shop, mobile } = req.body;

        const requiredFields = req.body.role != "seller" ? ['email', 'password', 'username', 'mobile'] : ['email', 'password', 'username', 'shop', 'mobile'];
